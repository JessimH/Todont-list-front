  ...
  <div>
    ...
    <form v-if="user.token">
        <p v-if="msg.success" style="color: green">{{msg.success}}</p>
                ...
                <button type="button" class="btn btn-primary mr-2" v-if="task.body.length !=0" @click.prevent="upTask(task)">Modifier</button>
                <button type="button" class="btn btn-danger ml-2" @click.prevent="delTask(task)" style="margin-right: 2%">Supprimer</button>
